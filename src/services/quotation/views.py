...
class CreateQuotationView(LoginRequiredMixin, CreateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        QuotationItemFormSet = modelformset_factory(QuotationItem, form=QuotationItemForm, extra=1)
    ...
    def form_valid(self, form):
        ...
        QuotationItemFormSet = modelformset_factory(QuotationItem, form=QuotationItemForm)
